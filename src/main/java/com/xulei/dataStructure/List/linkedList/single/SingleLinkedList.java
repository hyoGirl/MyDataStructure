package com.xulei.dataStructure.List.linkedList.single;


import com.xulei.dataStructure.List.linkedList.ILinkedList;
...
//			}
    ...
    public static void main(String[] args) {
    	 ...
    	 SingleLinkedList<String> ss=new SingleLinkedList<String>(letters);
